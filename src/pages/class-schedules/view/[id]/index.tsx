...
import { getClassScheduleById } from 'apiSdk/class-schedules';
...
function ClassScheduleViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('class_schedule', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/class-schedules/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('attendance', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/attendances/create?class_schedule_id=${data?.id}`}>
